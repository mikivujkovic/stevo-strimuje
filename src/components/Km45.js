...
export default class Km45 extends React.Component {
  ...
  componentDidMount() {
    ...
    const sortiranje = (a, b) => {
      return desetinke(a[9]) - desetinke(b[9])
    }
  ...
  render() {
    return (
      <div className="App">
        <div className="App">
        <div className="naslov">Female 45km Bike</div>
        ...
        <div className="naslov">Male 45km Bike</div>
          <table className="table">
            <thead>
              <tr className="tableHeader">
                <th className="header-100">Bib</th>
