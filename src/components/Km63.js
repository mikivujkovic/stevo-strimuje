...
export default class Km63 extends React.Component {
  ...
  componentDidMount() {
    ...
    const sortiranje = (a, b) => {
      return desetinke(a[10]) - desetinke(b[10])
    }
  ...
  render() {
    return (
      <div className="App">
        <div>
        <div className="naslov">Female 63km Bike</div>
        ...
        <div>
        <div className="naslov">Male 63km Bike</div>
          <table className="table">
            <thead>
              <tr className="tableHeader">
                <th className="header-100">Bib</th>
