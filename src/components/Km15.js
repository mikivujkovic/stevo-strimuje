...
export default class Km15 extends React.Component {
  ...
  componentDidMount() {
    ...
    const sortiranje = (a, b) => {
      return desetinke(a[15]) - desetinke(b[15])
    }
  ...
  render() {
    return (
      <div className="App">
        <div>
        <div className="naslov">Female 15km Run</div>
        ...
        <div>
        <div className="naslov">Male 15km Run</div>
          <table className="table">
            <thead>
              <tr className="tableHeader">
                <th className="header-100">Bib</th>
