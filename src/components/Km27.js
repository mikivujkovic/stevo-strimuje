...
export default class Km27 extends React.Component {
  ...
  componentDidMount() {
    ...
    const sortiranje = (a, b) => {
      return desetinke(a[8]) - desetinke(b[8])
    }
  ...
  render() {
    return (
      <div className="App">
        <div className="App">
        <div className="naslov">Female 27km Bike</div>
        ...
        <div className="naslov">Male 27km Bike</div>
          <table className="table">
            <thead>
              <tr className="tableHeader">
                <th className="header-100">Bib</th>
