...
export default class Km5 extends React.Component {
  ...
  componentDidMount() {
    ...
    const sortiranje = (a, b) => {
      return desetinke(a[13]) - desetinke(b[13])
    }
  ...
  render() {
    return (
      <div className="App">
        <div className="App">
        <div className="naslov">Female 5km Run</div>
        ...
        <div className="naslov">Male 5km Run</div>
          <table className="table">
            <thead>
              <tr className="tableHeader">
                <th className="header-100">Bib</th>
